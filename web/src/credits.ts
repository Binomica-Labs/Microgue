...
export const CREDIT_LONG = [
  "Microgue is the work of Binomica Labs.",
  `Licensed ${LICENCE_SHORT}: play it, share it, adapt it -- with credit,`,
  "not for sale, under the same terms.",
  REPO_URL,
];
