...
export const SOURCES: Partial<Record<GeneId, Source>> = {
  ...
  ccoN: { query: 'ccoN[Gene] AND "Pseudomonas stutzeri"[Organism]', organism: "Pseudomonas stutzeri" },
  cyoA: { query: 'cyoA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  sodA: { query: 'sodA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  psaA: { query: 'psaA[Gene] AND "Synechocystis"[Organism]', organism: "Synechocystis sp. PCC 6803" },
  hao: { query: 'hao[Gene] AND "Nitrosomonas europaea"[Organism]', organism: "Nitrosomonas europaea" },
  nrfA: { query: 'nrfA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  napA: { query: 'napA[Gene] AND "Paracoccus denitrificans"[Organism]', organism: "Paracoccus denitrificans" },
  mtrB: { query: 'mtrB[Gene] AND "Shewanella oneidensis"[Organism]', organism: "Shewanella oneidensis MR-1" },
  cymA: { query: 'cymA[Gene] AND "Shewanella oneidensis"[Organism]', organism: "Shewanella oneidensis MR-1" },
  mtoA: { query: 'mtoA[Gene] AND "Sideroxydans lithotrophicus"[Organism]', organism: "Sideroxydans lithotrophicus" },
  pioA: { query: 'pioA[Gene] AND "Rhodopseudomonas palustris"[Organism]', organism: "Rhodopseudomonas palustris TIE-1" },
  pufL: { query: 'pufL[Gene] AND "Rhodobacter sphaeroides"[Organism]', organism: "Rhodobacter sphaeroides" },
  crtI: { query: 'crtI[Gene] AND "Rhodobacter sphaeroides"[Organism]', organism: "Rhodobacter sphaeroides" },
  bchG: { query: 'bchG[Gene] AND "Chlorobium"[Organism]', organism: "Chlorobaculum tepidum" },
  dsrB: { query: 'dsrB[Gene] AND "Desulfovibrio vulgaris"[Organism]', organism: "Desulfovibrio vulgaris" },
  qmoA: { query: 'qmoA[Gene] AND "Desulfovibrio vulgaris"[Organism]', organism: "Desulfovibrio vulgaris" },
  hynL: { query: 'hynB[Gene] AND "Desulfovibrio gigas"[Organism]', organism: "Desulfovibrio gigas" },
  ...
  phsA: { query: 'phsA[Gene] AND "Salmonella enterica"[Organism]', organism: "Salmonella enterica" },
  ttrA: { query: 'ttrA[Gene] AND "Salmonella enterica"[Organism]', organism: "Salmonella enterica" },
  frdA: { query: 'frdA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  cooS: { query: 'cooS[Gene] AND "Rhodospirillum rubrum"[Organism]', organism: "Rhodospirillum rubrum" },
  pceA: { query: 'pceA[Gene] AND "Dehalococcoides"[Organism]', organism: "Dehalococcoides mccartyi" },
  arsC: { query: 'arsC[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  arrA: { query: 'arrA[Gene] AND "Shewanella"[Organism]', organism: "Shewanella sp. ANA-3" },
  mnhA: { query: 'mnhA[Gene] AND "Bacillus"[Organism]', organism: "Bacillus pseudofirmus" },
  atpB: { query: 'atpB[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  groL: { query: 'groL[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  dnaK: { query: 'dnaK[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  recA: { query: 'recA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  uvrA: { query: 'uvrA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  cheA: { query: 'cheA[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  flhD: { query: 'flhD[Gene] AND "Escherichia coli"[Organism]', organism: "Escherichia coli" },
  pilA: { query: 'pilA[Gene] AND "Geobacter sulfurreducens"[Organism]', organism: "Geobacter sulfurreducens" },
  pmoA: { query: 'pmoA[Gene] AND "Methylococcus capsulatus"[Organism]', organism: "Methylococcus capsulatus" },
  mmoX: { query: 'mmoX[Gene] AND "Methylococcus capsulatus"[Organism]', organism: "Methylococcus capsulatus" },
  frhA: { query: 'frhA[Gene] AND "Methanothermobacter"[Organism]', organism: "Methanothermobacter" },
  mtrH: { query: 'mtrH[Gene] AND "Methanosarcina barkeri"[Organism]', organism: "Methanosarcina barkeri" },
  hzsA: { query: 'hzsA[Gene] AND "Kuenenia stuttgartiensis"[Organism]', organism: "Kuenenia stuttgartiensis" },
  hdh: { query: 'hdh[Gene] AND "Kuenenia stuttgartiensis"[Organism]', organism: "Kuenenia stuttgartiensis" },
  acsB: { query: 'acsB[Gene] AND "Moorella thermoacetica"[Organism]', organism: "Moorella thermoacetica" },
  otsA: { query: 'otsA[Gene] AND "Escherichia coli K-12"[Organism]', organism: "Escherichia coli K-12" },
  cspA: { query: 'cspA[Gene] AND "Escherichia coli K-12"[Organism]', organism: "Escherichia coli K-12" },
