...
export const MICROBES: readonly Microbe[] = [
  ...
  { id:"pseudomonas",     name:"Pseudomonas",     depth:2, hp:12, atk:4,  glyph:"p", genes:["narG","nirS","norB","nosZ","dspB","napA","nrfA","ccoN","frdA","flhD","cheA","arsC"], note:"Facultative denitrifier. Carries the whole chain." , pigment:"#cfe04a" , facing:"rotate" , behaviour:"hunt", size:"medium" , weapon:"spear" },
  ...
  { id:"shewanella",      name:"Shewanella",      depth:4, hp:16, atk:6,  glyph:"S", genes:["mtrC","mtrB","cymA","mtoA","arrA","ttrA","frdA"],        note:"Mtr pathway respires minerals. Wildly versatile." , pigment:"#dd9078" , facing:"rotate" , behaviour:"flank", size:"medium" , weapon:"melee" },
