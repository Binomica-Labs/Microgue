...
export type GeneId =
  ...
  | "chiA" | "celA" | "dspB" | "epsA" | "comA" | "aprE" | "merA" | "czcA" | "copA" | "acrB" | "motA" | "fliC" | "cheY"
...
export const MICROBES: readonly Microbe[] = [
  ...
  { id:"pseudomonas",     name:"Pseudomonas",     depth:2, hp:12, atk:4,  glyph:"p", genes:["narG","nirS","norB","nosZ","dspB","napA","nrfA","ccoN","frdA","flhD","cheA","arsC","epsA","aprE","motA","fliC","cheY"], note:"Facultative denitrifier. Carries the whole chain." , pigment:"#cfe04a" , facing:"rotate" , behaviour:"hunt", size:"medium" , weapon:"spear" },
  ...
  { id:"vampirovibrio",   name:"Vampirovibrio",   depth:3, hp:14, atk:8,  glyph:"v", genes:["mtrC","katG","recA","sodA","aprE"], note:"Predatory bacterium. Lies still, then strikes." , pigment:"#c48fb0" , facing:"rotate" , behaviour:"ambush", size:"small" , weapon:"melee" },
  ...
  { id:"shewanella",      name:"Shewanella",      depth:4, hp:16, atk:6,  glyph:"S", genes:["mtrC","mtrB","cymA","mtoA","arrA","ttrA","frdA","comA","cheY","motA","acrB"],        note:"Mtr pathway respires minerals. Wildly versatile." , pigment:"#dd9078" , facing:"rotate" , behaviour:"flank", size:"medium" , weapon:"melee" },
