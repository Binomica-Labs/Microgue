...
export const MICROBES: readonly Microbe[] = [
  ...
  { id:"pseudomonas",     name:"Pseudomonas",     depth:2, hp:12, atk:4,  glyph:"p", genes:["narG","nirS","norB","nosZ","dspB","napA","nrfA","ccoN","frdA","flhD","cheA","arsC","epsA"], note:"Facultative denitrifier. Carries the whole chain." , pigment:"#cfe04a" , facing:"rotate" , behaviour:"hunt", size:"medium" , weapon:"spear" },
  ...
  { id:"vampirovibrio",   name:"Vampirovibrio",   depth:3, hp:14, atk:8,  glyph:"v", genes:["mtrC","katG","recA","sodA"], note:"Predatory bacterium. Lies still, then strikes." , pigment:"#c48fb0" , facing:"rotate" , behaviour:"ambush", size:"small" , weapon:"melee" },
