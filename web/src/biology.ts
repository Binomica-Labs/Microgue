...
export const GENES: Readonly<Record<GeneId, Gene>> = {
  ...
  comA: { id:"comA", name:"comA", kb:1.0, product:"competence DNA uptake channel", tier:3, desc:"Take up ambient DNA from the water. Sometimes it is useful.", discovery:"Natural competence lets bacteria like Bacillus and Haemophilus import naked DNA straight from their surroundings -- how Griffith's 1928 transforming principle worked, decades before anyone knew it was DNA.", pathway:"defense" },
  aprE: { id:"aprE", name:"aprE", kb:1.1, product:"subtilisin protease", tier:3, desc:"Secreted protease. Lays a sheet that digests what crosses it.", discovery:"Subtilisin from Bacillus subtilis is the workhorse industrial protease -- it is in most laundry detergent. The cell secretes it to strip protein from its surroundings.", pathway:"defense" },
  epsA: { id:"epsA", name:"epsA", kb:1.3, product:"exopolysaccharide synthase", tier:2, desc:"Secretes the polymer that builds a biofilm. Hold ground with it.", discovery:"The eps gene clusters build the extracellular matrix that is most of a biofilm by volume -- the cells are a minority of what you see.", pathway:"defense" },
...
export const MICROBES: readonly Microbe[] = [
  ...
  { id:"bdellovibrio",   name:"Bdellovibrio",   depth:1, weight:0.25, hp:7,  atk:3,  glyph:"b", genes:["flhD","recA","aprE","sodA"], note:"Predatory bacterium. Hunts other cells; backs off when hurt." , pigment:"#e0a37a" , facing:"rotate" , behaviour:"hunt", size:"small" , weapon:"melee" },
  ...
  { id:"pseudomonas",     name:"Pseudomonas",     depth:2, hp:12, atk:4,  glyph:"p", genes:["narG","nirS","norB","nosZ","dspB","napA","nrfA","ccoN","frdA","flhD","cheA","arsC","epsA","aprE"], note:"Facultative denitrifier. Carries the whole chain." , pigment:"#cfe04a" , facing:"rotate" , behaviour:"hunt", size:"medium" , weapon:"spear" },
  ...
  { id:"geobacter",       name:"Geobacter",       depth:4, hp:18, atk:7,  glyph:"G", genes:["omcS","mtrC","dspB","mtrB","cymA","pilA","arrA","epsA"], note:"Grows conductive pili. Reduces solid Fe(III) oxides." , pigment:"#d0603c" , facing:"rotate" , behaviour:"wire", size:"medium" , weapon:"bolt" },
  { id:"shewanella",      name:"Shewanella",      depth:4, hp:16, atk:6,  glyph:"S", genes:["mtrC","mtrB","cymA","mtoA","arrA","ttrA","frdA","comA"],        note:"Mtr pathway respires minerals. Wildly versatile." , pigment:"#dd9078" , facing:"rotate" , behaviour:"flank", size:"medium" , weapon:"melee" },
  ...
  { id:"desulfovibrio",   name:"Desulfovibrio",   depth:7, hp:28, atk:11, glyph:"D", genes:["dsrA","hydA","dsrB","qmoA","hynL","pceA","mnhA","otsA"], note:"Sulfate reducer. Exhaled H2S blackens the sediment." , pigment:"#a6acb6" , facing:"rotate" , behaviour:"leech", size:"medium" , weapon:"cloud" },
